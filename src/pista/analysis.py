...
class Analyzer():
    ...
    def __call__(self, input_df=None, wcs=None, data=None,
      ...
      if photometry == 'Aper':
        self.aper_photometry(data, wcs, input_df, fwhm, sigma, detect_sources,
                             zero_point)
      elif photometry == 'PSF':
        self.psf_photometry(data, wcs, input_df, fwhm, sigma, zero_point)
